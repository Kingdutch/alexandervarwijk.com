  ...
  <Layout isFront={true}>
    ...
    <aside>
        <p>
            ...
            my focus in the world of Webdevelopment.
        </p>
        <p>
            I'm currently working at <a href={"https://www.getopensocial.com"} title={"Open Social - Online community software"}>Open social</a>.
        ...
        <p>
            You can view more of my work history on <a href={"https://www.linkedin.com/in/alexander-varwijk/"} title={"Alexander Varwijk's LinkedIn Profile"}>LinkedIn</a>.
            My code is mostly hosted on <a href={"https://github.com/Kingdutch"} title={"Alexander Varwijk's GitHub Profile"}>GitHub</a>. Random thoughts and blurts can be
            found on <a href={"https://twitter.com/Kingdutch/"} title={"Alexander Varwijk on Twitter"}>Twitter</a>.
        </p>
    </aside>
    <main>
        <h2>Recent Posts</h2>
