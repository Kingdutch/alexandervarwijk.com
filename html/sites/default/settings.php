 ...
 * @endcode
 */
$settings['hash_salt'] = 'IbseIu4X5G4xYu_64xyLCBjy64kjdqhQVDHaYc-NkCNjHJc5aAWBclgLcHXDdOp7_e7pkEkQCA';
...
/**
 * Ignore development specific modules in our config management.
 */
$settings['config_exclude_modules'] = ['field_ui', 'views_ui'];

/**
 * Load Platform.sh override configuration, if available.
 */
...
/**
 * Load docker override configuration, if available.
 */
